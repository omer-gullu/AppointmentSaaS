...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260322172525_AddSaaSBaseAndDynamicContext")]
    partial class AddSaaSBaseAndDynamicContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 3, 22, 20, 25, 21, 142, DateTimeKind.Local).AddTicks(1039),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 3, 22, 20, 25, 21, 142, DateTimeKind.Local).AddTicks(1066),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 3, 22, 20, 25, 21, 142, DateTimeKind.Local).AddTicks(1073),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 22, 20, 25, 21, 142, DateTimeKind.Local).AddTicks(1663),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 22, 20, 25, 21, 142, DateTimeKind.Local).AddTicks(1678),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 22, 20, 25, 21, 142, DateTimeKind.Local).AddTicks(1689),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
