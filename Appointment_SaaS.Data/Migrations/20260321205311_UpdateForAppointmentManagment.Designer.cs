...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260321205311_UpdateForAppointmentManagment")]
    partial class UpdateForAppointmentManagment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 3, 21, 23, 53, 7, 969, DateTimeKind.Local).AddTicks(1328),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 3, 21, 23, 53, 7, 969, DateTimeKind.Local).AddTicks(1354),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 3, 21, 23, 53, 7, 969, DateTimeKind.Local).AddTicks(1358),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 21, 23, 53, 7, 969, DateTimeKind.Local).AddTicks(3103),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 21, 23, 53, 7, 969, DateTimeKind.Local).AddTicks(3121),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 21, 23, 53, 7, 969, DateTimeKind.Local).AddTicks(3127),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
