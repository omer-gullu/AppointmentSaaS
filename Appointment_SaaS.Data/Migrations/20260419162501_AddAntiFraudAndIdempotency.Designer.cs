...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260419162501_AddAntiFraudAndIdempotency")]
    partial class AddAntiFraudAndIdempotency
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 4, 19, 19, 24, 56, 484, DateTimeKind.Local).AddTicks(8026),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 4, 19, 19, 24, 56, 484, DateTimeKind.Local).AddTicks(8054),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 4, 19, 19, 24, 56, 484, DateTimeKind.Local).AddTicks(8063),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 19, 19, 24, 56, 484, DateTimeKind.Local).AddTicks(8252),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 19, 19, 24, 56, 484, DateTimeKind.Local).AddTicks(8268),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 19, 19, 24, 56, 484, DateTimeKind.Local).AddTicks(8281),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
