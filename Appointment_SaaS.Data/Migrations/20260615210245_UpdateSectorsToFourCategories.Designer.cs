...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260615210245_UpdateSectorsToFourCategories")]
    partial class UpdateSectorsToFourCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SecurityStamp = "52ef2e75-6f7b-4fca-972b-037d3a09d1ba",
                            Status = true,
                            TenantID = 1
                        });
                });
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            SectorID = 4,
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            DefaultPrompt = "Sen psikolog randevu asistanısın. Görüşme randevularında empatik, saygılı, gizliliğe özen gösteren ve sakin bir dille konuş.",
                            Name = "Psikolog"
                        });
                });
