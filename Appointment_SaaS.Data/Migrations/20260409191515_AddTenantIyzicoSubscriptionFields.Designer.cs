...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260409191515_AddTenantIyzicoSubscriptionFields")]
    partial class AddTenantIyzicoSubscriptionFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 4, 9, 22, 15, 10, 426, DateTimeKind.Local).AddTicks(4293),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 4, 9, 22, 15, 10, 426, DateTimeKind.Local).AddTicks(4325),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 4, 9, 22, 15, 10, 426, DateTimeKind.Local).AddTicks(4329),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 9, 22, 15, 10, 426, DateTimeKind.Local).AddTicks(4468),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 9, 22, 15, 10, 426, DateTimeKind.Local).AddTicks(4480),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 9, 22, 15, 10, 426, DateTimeKind.Local).AddTicks(4487),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
