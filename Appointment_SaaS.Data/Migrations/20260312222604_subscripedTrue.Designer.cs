...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260312222604_subscripedTrue")]
    partial class subscripedTrue
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 3, 13, 1, 26, 1, 342, DateTimeKind.Local).AddTicks(4463),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 3, 13, 1, 26, 1, 342, DateTimeKind.Local).AddTicks(4492),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 3, 13, 1, 26, 1, 342, DateTimeKind.Local).AddTicks(4495),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 13, 1, 26, 1, 342, DateTimeKind.Local).AddTicks(4847),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 13, 1, 26, 1, 342, DateTimeKind.Local).AddTicks(4856),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 13, 1, 26, 1, 342, DateTimeKind.Local).AddTicks(4861),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
