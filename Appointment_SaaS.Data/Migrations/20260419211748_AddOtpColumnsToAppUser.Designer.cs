...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260419211748_AddOtpColumnsToAppUser")]
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 4, 20, 0, 17, 43, 558, DateTimeKind.Local).AddTicks(3668),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 4, 20, 0, 17, 43, 558, DateTimeKind.Local).AddTicks(3702),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 4, 20, 0, 17, 43, 558, DateTimeKind.Local).AddTicks(3708),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 20, 0, 17, 43, 558, DateTimeKind.Local).AddTicks(3803),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 20, 0, 17, 43, 558, DateTimeKind.Local).AddTicks(3813),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 20, 0, 17, 43, 558, DateTimeKind.Local).AddTicks(3820),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
