...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260226174236_InitialCreatePasswordHashAndSalt")]
    partial class InitialCreatePasswordHashAndSalt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 2, 26, 20, 42, 34, 907, DateTimeKind.Local).AddTicks(4168),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 2, 26, 20, 42, 34, 907, DateTimeKind.Local).AddTicks(4187),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 2, 26, 20, 42, 34, 907, DateTimeKind.Local).AddTicks(4189),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 2, 26, 20, 42, 34, 907, DateTimeKind.Local).AddTicks(4411),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 2, 26, 20, 42, 34, 907, DateTimeKind.Local).AddTicks(4416),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = false,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 2, 26, 20, 42, 34, 907, DateTimeKind.Local).AddTicks(4420),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = false,
                            IsTrial = false,
