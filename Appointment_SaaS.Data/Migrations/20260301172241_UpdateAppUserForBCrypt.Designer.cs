...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260301172241_UpdateAppUserForBCrypt")]
    partial class UpdateAppUserForBCrypt
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 3, 1, 20, 22, 39, 743, DateTimeKind.Local).AddTicks(6192),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 3, 1, 20, 22, 39, 743, DateTimeKind.Local).AddTicks(6208),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 3, 1, 20, 22, 39, 743, DateTimeKind.Local).AddTicks(6209),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 1, 20, 22, 39, 743, DateTimeKind.Local).AddTicks(6416),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 1, 20, 22, 39, 743, DateTimeKind.Local).AddTicks(6430),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = false,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 1, 20, 22, 39, 743, DateTimeKind.Local).AddTicks(6433),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = false,
                            IsTrial = false,
