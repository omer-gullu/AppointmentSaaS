...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260422192936_AddAdminSeedData")]
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 4, 22, 22, 29, 19, 987, DateTimeKind.Local).AddTicks(4293),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 4, 22, 22, 29, 19, 987, DateTimeKind.Local).AddTicks(4328),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 4, 22, 22, 29, 19, 987, DateTimeKind.Local).AddTicks(4333),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 22, 22, 29, 19, 987, DateTimeKind.Local).AddTicks(4541),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 22, 22, 29, 19, 987, DateTimeKind.Local).AddTicks(4551),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 22, 22, 29, 19, 987, DateTimeKind.Local).AddTicks(4558),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
