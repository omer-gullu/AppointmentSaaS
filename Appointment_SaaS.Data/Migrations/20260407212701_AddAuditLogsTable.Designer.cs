...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260407212701_AddAuditLogsTable")]
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 4, 8, 0, 26, 57, 493, DateTimeKind.Local).AddTicks(1204),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 4, 8, 0, 26, 57, 493, DateTimeKind.Local).AddTicks(1232),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 4, 8, 0, 26, 57, 493, DateTimeKind.Local).AddTicks(1237),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 8, 0, 26, 57, 493, DateTimeKind.Local).AddTicks(1329),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 8, 0, 26, 57, 493, DateTimeKind.Local).AddTicks(1342),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 8, 0, 26, 57, 493, DateTimeKind.Local).AddTicks(1349),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
