...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260301202019_AddTrialDatesToAppUser")]
    partial class AddTrialDatesToAppUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 3, 1, 23, 20, 17, 429, DateTimeKind.Local).AddTicks(8645),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 3, 1, 23, 20, 17, 429, DateTimeKind.Local).AddTicks(8661),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 3, 1, 23, 20, 17, 429, DateTimeKind.Local).AddTicks(8663),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 1, 23, 20, 17, 429, DateTimeKind.Local).AddTicks(8941),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 1, 23, 20, 17, 429, DateTimeKind.Local).AddTicks(8946),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = false,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 1, 23, 20, 17, 429, DateTimeKind.Local).AddTicks(8949),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = false,
                            IsTrial = false,
