...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260324195556_AddInstanceName")]
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 3, 24, 22, 55, 53, 246, DateTimeKind.Local).AddTicks(1091),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 3, 24, 22, 55, 53, 246, DateTimeKind.Local).AddTicks(1112),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 3, 24, 22, 55, 53, 246, DateTimeKind.Local).AddTicks(1115),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 24, 22, 55, 53, 246, DateTimeKind.Local).AddTicks(1411),
                            IsActive = true,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 24, 22, 55, 53, 246, DateTimeKind.Local).AddTicks(1416),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 3, 24, 22, 55, 53, 246, DateTimeKind.Local).AddTicks(1420),
                            IsActive = true,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                            IsTrial = false,
