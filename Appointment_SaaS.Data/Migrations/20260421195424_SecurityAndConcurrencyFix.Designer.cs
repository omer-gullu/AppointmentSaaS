...
namespace Appointment_SaaS.Data.Migrations
{
    ...
    [Migration("20260421195424_SecurityAndConcurrencyFix")]
    partial class SecurityAndConcurrencyFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Sector", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SectorID = 1,
                            CreatedAt = new DateTime(2026, 4, 21, 22, 54, 15, 250, DateTimeKind.Local).AddTicks(2550),
                        ...
                        {
                            SectorID = 2,
                            CreatedAt = new DateTime(2026, 4, 21, 22, 54, 15, 250, DateTimeKind.Local).AddTicks(2585),
                        ...
                        {
                            SectorID = 3,
                            CreatedAt = new DateTime(2026, 4, 21, 22, 54, 15, 250, DateTimeKind.Local).AddTicks(2590),
            ...
            modelBuilder.Entity("Appointment_SaaS.Core.Entities.Tenant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApiKey = "JNT-123-ABC",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 21, 22, 54, 15, 250, DateTimeKind.Local).AddTicks(2785),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "ISL-456-DEF",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 21, 22, 54, 15, 250, DateTimeKind.Local).AddTicks(2794),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
                        ...
                        new
                        {
                            ...
                            ApiKey = "MOD-789-GHI",
                            AutoRenew = true,
                            CreatedAt = new DateTime(2026, 4, 21, 22, 54, 15, 250, DateTimeKind.Local).AddTicks(3070),
                            IsActive = true,
                            IsBlacklisted = false,
                            IsBotActive = true,
                            IsSubscriptionActive = true,
